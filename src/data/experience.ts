...
export const experience: ExperienceItem[] = [
  {
    ...
    bullets: [
      ...
      "I owned the company's cloud infrastructure and its migration end-to-end. The platform first launched on Azure (Container Apps, Container Registry, Azure Database for PostgreSQL Flexible Server, Key Vault, Application Insights), and after we were accepted into the Google for Startups program I re-platformed it onto GCP — Cloud Run, Cloud SQL for PostgreSQL, Secret Manager, and CI/CD via Workload Identity Federation — including a 5-minute background Plaid sync job so users always see live bank data. My role covered architecture, feature development, cloud operations, security hardening, production-readiness planning, and cross-platform integration across mobile, API, database, and third-party financial services."
    ],
  },
  {
    role: "AI Engineer",
