    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-purple-950/20">
      ...
      <article className="mx-auto max-w-4xl px-6 py-16">
        <div className="prose prose-xl prose-invert max-w-none
          ...
          prose-h2:text-3xl prose-h2:leading-tight prose-h2:mt-16 prose-h2:mb-8 prose-h2:text-purple-200 prose-h2:border-b prose-h2:border-purple-500/30 prose-h2:pb-4
          ...
          prose-p:text-gray-100 prose-p:leading-loose prose-p:mb-8 prose-p:text-lg
          ...
          prose-pre:bg-slate-900 prose-pre:border prose-pre:border-purple-500/30 prose-pre:rounded-2xl prose-pre:p-8 prose-pre:overflow-x-auto prose-pre:shadow-2xl prose-pre:ring-2 prose-pre:ring-purple-500/20 prose-pre:my-10 prose-pre:text-sm prose-pre:leading-relaxed
          ...
          prose-ul:space-y-3 prose-ul:text-gray-100 prose-ul:my-8 prose-ul:text-lg
          prose-ol:space-y-3 prose-ol:text-gray-100 prose-ol:my-8 prose-ol:text-lg
          prose-li:text-gray-100 prose-li:leading-loose prose-li:pl-2
          ...
          prose-td:border prose-td:border-purple-500/20 prose-td:px-6 prose-td:py-4 prose-td:text-gray-100 prose-td:text-lg prose-td:leading-relaxed"
        >
          <MDX />
        </div>
      </article>
