---
title: My Experience with Sentiment Analysis: From Data to Deployment
summary: A comprehensive journey through building a sentiment analysis system using machine learning, from data preprocessing to model deployment on Streamlit.
date: 2025-01-12
readTime: 7 min read
tags: Machine Learning, Sentiment Analysis, Python, Streamlit, NLP
---
...
def main():
    ...
    if st.button("Analyze Sentiment"):
        if user_input:
            ...
            # Display results
            sentiment_emoji = "😊" if prediction == "positive" else "😢" if prediction == "negative" else "😐"
